;(function($) {
	...
	window.ccp_main = function(){
		...
		iframe.on("click", 'a[href]', function(evt) {
		    ...
		    if(href.indexOf("ccp-iframe=true") == -1){
				...
				// Add and redirect
				document.getElementById("ccp-iframe").contentWindow.location.href = ccp_add_query_arg(href, "ccp-iframe", "true");
	...
	var get_absolute_path = function(href) {
        var link = document.getElementById("ccp-iframe").contentWindow.document.createElement("a");
        link.href = href;
